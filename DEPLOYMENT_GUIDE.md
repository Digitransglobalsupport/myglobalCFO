...
```
REACT_APP_BACKEND_URL=https://metric-builder.preview.emergentagent.com/api
```
This results in routes like: `https://metric-builder.preview.emergentagent.com/api/api/auth/register` (double `/api`)

**✅ CORRECT Configuration:**
```
REACT_APP_BACKEND_URL=https://metric-builder.preview.emergentagent.com
```
This results in routes like: `https://metric-builder.preview.emergentagent.com/api/auth/register`
...
**Expected Request:**
```
POST https://metric-builder.preview.emergentagent.com/api/auth/register
```
...
curl -X OPTIONS \
  https://metric-builder.preview.emergentagent.com/api/auth/register \
