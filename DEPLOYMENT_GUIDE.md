...
```
REACT_APP_BACKEND_URL=https://finviz-19.preview.emergentagent.com/api
```
This results in routes like: `https://finviz-19.preview.emergentagent.com/api/api/auth/register` (double `/api`)

**✅ CORRECT Configuration:**
```
REACT_APP_BACKEND_URL=https://finviz-19.preview.emergentagent.com
```
This results in routes like: `https://finviz-19.preview.emergentagent.com/api/auth/register`
...
**Expected Request:**
```
POST https://finviz-19.preview.emergentagent.com/api/auth/register
```
...
curl -X OPTIONS \
  https://finviz-19.preview.emergentagent.com/api/auth/register \
