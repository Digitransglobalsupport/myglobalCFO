...
```
REACT_APP_BACKEND_URL=https://featurectl.preview.emergentagent.com/api
```
This results in routes like: `https://featurectl.preview.emergentagent.com/api/api/auth/register` (double `/api`)

**✅ CORRECT Configuration:**
```
REACT_APP_BACKEND_URL=https://featurectl.preview.emergentagent.com
```
This results in routes like: `https://featurectl.preview.emergentagent.com/api/auth/register`
...
**Expected Request:**
```
POST https://featurectl.preview.emergentagent.com/api/auth/register
```
...
curl -X OPTIONS \
  https://featurectl.preview.emergentagent.com/api/auth/register \
