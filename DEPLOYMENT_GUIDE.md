...
```
This results in routes like: `https://digitrans-web-fix.preview.emergentagent.com/api/api/auth/register` (double `/api`)

**✅ CORRECT Configuration:**
```
REACT_APP_BACKEND_URL=https://digitrans-web-fix.preview.emergentagent.com
```
This results in routes like: `https://digitrans-web-fix.preview.emergentagent.com/api/auth/register`
...
**Expected Request:**
```
POST https://digitrans-web-fix.preview.emergentagent.com/api/auth/register
```
