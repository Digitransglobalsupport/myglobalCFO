...
```
REACT_APP_BACKEND_URL=https://saas-migration-3.preview.emergentagent.com/api
```
This results in routes like: `https://saas-migration-3.preview.emergentagent.com/api/api/auth/register` (double `/api`)

**✅ CORRECT Configuration:**
```
REACT_APP_BACKEND_URL=https://saas-migration-3.preview.emergentagent.com
```
This results in routes like: `https://saas-migration-3.preview.emergentagent.com/api/auth/register`
...
**Expected Request:**
```
POST https://saas-migration-3.preview.emergentagent.com/api/auth/register
```
...
curl -X OPTIONS \
  https://saas-migration-3.preview.emergentagent.com/api/auth/register \
