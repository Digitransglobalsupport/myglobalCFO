...
```
REACT_APP_BACKEND_URL=https://asset-path-fixes.preview.emergentagent.com/api
```
This results in routes like: `https://asset-path-fixes.preview.emergentagent.com/api/api/auth/register` (double `/api`)

**✅ CORRECT Configuration:**
```
REACT_APP_BACKEND_URL=https://asset-path-fixes.preview.emergentagent.com
```
This results in routes like: `https://asset-path-fixes.preview.emergentagent.com/api/auth/register`
...
**Expected Request:**
```
POST https://asset-path-fixes.preview.emergentagent.com/api/auth/register
```
...
curl -X OPTIONS \
  https://asset-path-fixes.preview.emergentagent.com/api/auth/register \
