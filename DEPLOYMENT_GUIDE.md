...
```
REACT_APP_BACKEND_URL=https://fin-autogit.preview.emergentagent.com/api
```
This results in routes like: `https://fin-autogit.preview.emergentagent.com/api/api/auth/register` (double `/api`)

**✅ CORRECT Configuration:**
```
REACT_APP_BACKEND_URL=https://fin-autogit.preview.emergentagent.com
```
This results in routes like: `https://fin-autogit.preview.emergentagent.com/api/auth/register`
...
**Expected Request:**
```
POST https://fin-autogit.preview.emergentagent.com/api/auth/register
```
...
curl -X OPTIONS \
  https://fin-autogit.preview.emergentagent.com/api/auth/register \
