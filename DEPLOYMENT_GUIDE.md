...
```
REACT_APP_BACKEND_URL=https://core-consolidate.preview.emergentagent.com/api
```
This results in routes like: `https://core-consolidate.preview.emergentagent.com/api/api/auth/register` (double `/api`)

**✅ CORRECT Configuration:**
```
REACT_APP_BACKEND_URL=https://core-consolidate.preview.emergentagent.com
```
This results in routes like: `https://core-consolidate.preview.emergentagent.com/api/auth/register`
...
**Expected Request:**
```
POST https://core-consolidate.preview.emergentagent.com/api/auth/register
```
...
curl -X OPTIONS \
  https://core-consolidate.preview.emergentagent.com/api/auth/register \
