...
```
REACT_APP_BACKEND_URL=https://datatogglecfo.preview.emergentagent.com/api
```
This results in routes like: `https://datatogglecfo.preview.emergentagent.com/api/api/auth/register` (double `/api`)

**✅ CORRECT Configuration:**
```
REACT_APP_BACKEND_URL=https://datatogglecfo.preview.emergentagent.com
```
This results in routes like: `https://datatogglecfo.preview.emergentagent.com/api/auth/register`
...
**Expected Request:**
```
POST https://datatogglecfo.preview.emergentagent.com/api/auth/register
```
...
curl -X OPTIONS \
  https://datatogglecfo.preview.emergentagent.com/api/auth/register \
