...
```
REACT_APP_BACKEND_URL=https://stratcap-monitor.preview.emergentagent.com/api
```
This results in routes like: `https://stratcap-monitor.preview.emergentagent.com/api/api/auth/register` (double `/api`)

**✅ CORRECT Configuration:**
```
REACT_APP_BACKEND_URL=https://stratcap-monitor.preview.emergentagent.com
```
This results in routes like: `https://stratcap-monitor.preview.emergentagent.com/api/auth/register`
...
**Expected Request:**
```
POST https://stratcap-monitor.preview.emergentagent.com/api/auth/register
```
...
curl -X OPTIONS \
  https://stratcap-monitor.preview.emergentagent.com/api/auth/register \
