...
```
This results in routes like: `https://glass-ui-refresh.preview.emergentagent.com/api/api/auth/register` (double `/api`)

**✅ CORRECT Configuration:**
```
REACT_APP_BACKEND_URL=https://glass-ui-refresh.preview.emergentagent.com
```
This results in routes like: `https://glass-ui-refresh.preview.emergentagent.com/api/auth/register`
...
**Expected Request:**
```
POST https://glass-ui-refresh.preview.emergentagent.com/api/auth/register
```
