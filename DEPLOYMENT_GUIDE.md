...
```
REACT_APP_BACKEND_URL=https://enterprise-finance-8.preview.emergentagent.com/api
```
This results in routes like: `https://enterprise-finance-8.preview.emergentagent.com/api/api/auth/register` (double `/api`)

**✅ CORRECT Configuration:**
```
REACT_APP_BACKEND_URL=https://enterprise-finance-8.preview.emergentagent.com
```
This results in routes like: `https://enterprise-finance-8.preview.emergentagent.com/api/auth/register`
...
**Expected Request:**
```
POST https://enterprise-finance-8.preview.emergentagent.com/api/auth/register
```
...
curl -X OPTIONS \
  https://enterprise-finance-8.preview.emergentagent.com/api/auth/register \
