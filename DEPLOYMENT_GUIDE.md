...
```
This results in routes like: `https://server-config-9.preview.emergentagent.com/api/api/auth/register` (double `/api`)

**✅ CORRECT Configuration:**
```
REACT_APP_BACKEND_URL=https://server-config-9.preview.emergentagent.com
```
This results in routes like: `https://server-config-9.preview.emergentagent.com/api/auth/register`
...
**Expected Request:**
```
POST https://server-config-9.preview.emergentagent.com/api/auth/register
```
