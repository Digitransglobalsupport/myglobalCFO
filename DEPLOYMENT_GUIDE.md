...
```
REACT_APP_BACKEND_URL=https://test-deploy-fix.preview.emergentagent.com/api
```
This results in routes like: `https://test-deploy-fix.preview.emergentagent.com/api/api/auth/register` (double `/api`)

**✅ CORRECT Configuration:**
```
REACT_APP_BACKEND_URL=https://test-deploy-fix.preview.emergentagent.com
```
This results in routes like: `https://test-deploy-fix.preview.emergentagent.com/api/auth/register`
...
**Expected Request:**
```
POST https://test-deploy-fix.preview.emergentagent.com/api/auth/register
```
...
curl -X OPTIONS \
  https://test-deploy-fix.preview.emergentagent.com/api/auth/register \
