...
curl -H "Authorization: Bearer YOUR_TOKEN" \
  https://enterprise-finance-8.preview.emergentagent.com/api/longtail/stats
```
...
```bash
curl -H "Authorization: Bearer YOUR_TOKEN" \
  https://enterprise-finance-8.preview.emergentagent.com/api/longtail/history?limit=50
```
