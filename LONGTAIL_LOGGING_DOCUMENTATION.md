...
curl -H "Authorization: Bearer YOUR_TOKEN" \
  https://progress-bar-repair-1.preview.emergentagent.com/api/longtail/stats
```
...
```bash
curl -H "Authorization: Bearer YOUR_TOKEN" \
  https://progress-bar-repair-1.preview.emergentagent.com/api/longtail/history?limit=50
```
