...
## Prerequisites
- Access to: https://progress-bar-repair-1.preview.emergentagent.com
...
1. **Login to Application**
   - Navigate to https://progress-bar-repair-1.preview.emergentagent.com
...
curl "https://progress-bar-repair-1.preview.emergentagent.com/api/reference/currencies"

# Test dashboard currency field (requires auth token)
curl "https://progress-bar-repair-1.preview.emergentagent.com/api/cfo/dashboard/overview?company_id=<COMPANY_ID>&use_mocked_data=true" \
