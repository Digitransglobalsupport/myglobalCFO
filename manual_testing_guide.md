...
## Prerequisites
- Access to: https://corpfinance-3.preview.emergentagent.com
...
1. **Login to Application**
   - Navigate to https://corpfinance-3.preview.emergentagent.com
...
curl "https://corpfinance-3.preview.emergentagent.com/api/reference/currencies"

# Test dashboard currency field (requires auth token)
curl "https://corpfinance-3.preview.emergentagent.com/api/cfo/dashboard/overview?company_id=<COMPANY_ID>&use_mocked_data=true" \
