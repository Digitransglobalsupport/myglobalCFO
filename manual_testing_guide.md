...
## Prerequisites
- Access to: https://server-config-9.preview.emergentagent.com
...
1. **Login to Application**
   - Navigate to https://server-config-9.preview.emergentagent.com
...
curl "https://server-config-9.preview.emergentagent.com/api/reference/currencies"

# Test dashboard currency field (requires auth token)
curl "https://server-config-9.preview.emergentagent.com/api/cfo/dashboard/overview?company_id=<COMPANY_ID>&use_mocked_data=true" \
