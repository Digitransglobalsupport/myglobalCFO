...
## Prerequisites
- Access to: https://enterprise-finance-8.preview.emergentagent.com
...
1. **Login to Application**
   - Navigate to https://enterprise-finance-8.preview.emergentagent.com
...
curl "https://enterprise-finance-8.preview.emergentagent.com/api/reference/currencies"

# Test dashboard currency field (requires auth token)
curl "https://enterprise-finance-8.preview.emergentagent.com/api/cfo/dashboard/overview?company_id=<COMPANY_ID>&use_mocked_data=true" \
