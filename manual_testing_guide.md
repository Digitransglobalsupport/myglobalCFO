...
## Prerequisites
- Access to: https://asset-path-fixes.preview.emergentagent.com
...
1. **Login to Application**
   - Navigate to https://asset-path-fixes.preview.emergentagent.com
...
curl "https://asset-path-fixes.preview.emergentagent.com/api/reference/currencies"

# Test dashboard currency field (requires auth token)
curl "https://asset-path-fixes.preview.emergentagent.com/api/cfo/dashboard/overview?company_id=<COMPANY_ID>&use_mocked_data=true" \
