...
- Verified single, correct redirect URI: `https://cfo-toolkit-1.preview.emergentagent.com/api/integrations/xero/callback`
...
```
XERO_REDIRECT_URI="https://cfo-toolkit-1.preview.emergentagent.com/api/integrations/xero/callback"
```
