...
- Verified single, correct redirect URI: `https://fin-autogit.preview.emergentagent.com/api/integrations/xero/callback`
...
```
XERO_REDIRECT_URI="https://fin-autogit.preview.emergentagent.com/api/integrations/xero/callback"
```
