...
- Verified single, correct redirect URI: `https://globalcfo-app.preview.emergentagent.com/api/integrations/xero/callback`
...
```
XERO_REDIRECT_URI="https://globalcfo-app.preview.emergentagent.com/api/integrations/xero/callback"
```
