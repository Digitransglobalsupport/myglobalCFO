...
- Verified single, correct redirect URI: `https://enterprise-finance-8.preview.emergentagent.com/api/integrations/xero/callback`
...
```
XERO_REDIRECT_URI="https://enterprise-finance-8.preview.emergentagent.com/api/integrations/xero/callback"
```
