...
- Verified single, correct redirect URI: `https://metric-builder.preview.emergentagent.com/api/integrations/xero/callback`
...
```
XERO_REDIRECT_URI="https://metric-builder.preview.emergentagent.com/api/integrations/xero/callback"
```
