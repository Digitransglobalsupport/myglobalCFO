...
- Verified single, correct redirect URI: `https://stratcap-monitor.preview.emergentagent.com/api/integrations/xero/callback`
...
```
XERO_REDIRECT_URI="https://stratcap-monitor.preview.emergentagent.com/api/integrations/xero/callback"
```
