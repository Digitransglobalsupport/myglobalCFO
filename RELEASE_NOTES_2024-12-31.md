...
- Verified single, correct redirect URI: `https://glass-ui-refresh.preview.emergentagent.com/api/integrations/xero/callback`
...
```
XERO_REDIRECT_URI="https://glass-ui-refresh.preview.emergentagent.com/api/integrations/xero/callback"
```
