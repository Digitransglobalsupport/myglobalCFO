...
- Verified single, correct redirect URI: `https://test-deploy-fix.preview.emergentagent.com/api/integrations/xero/callback`
...
```
XERO_REDIRECT_URI="https://test-deploy-fix.preview.emergentagent.com/api/integrations/xero/callback"
```
