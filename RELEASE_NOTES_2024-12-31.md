...
- Verified single, correct redirect URI: `https://global-finance-10.preview.emergentagent.com/api/integrations/xero/callback`
...
```
XERO_REDIRECT_URI="https://global-finance-10.preview.emergentagent.com/api/integrations/xero/callback"
```
