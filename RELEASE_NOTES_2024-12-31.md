...
- Verified single, correct redirect URI: `https://financeai-55.preview.emergentagent.com/api/integrations/xero/callback`
...
```
XERO_REDIRECT_URI="https://financeai-55.preview.emergentagent.com/api/integrations/xero/callback"
```
