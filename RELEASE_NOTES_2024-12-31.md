...
- Verified single, correct redirect URI: `https://plan-gating-1.preview.emergentagent.com/api/integrations/xero/callback`
...
```
XERO_REDIRECT_URI="https://plan-gating-1.preview.emergentagent.com/api/integrations/xero/callback"
```
