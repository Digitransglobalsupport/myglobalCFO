...
- Verified single, correct redirect URI: `https://digitrans-web-fix.preview.emergentagent.com/api/integrations/xero/callback`
...
```
XERO_REDIRECT_URI="https://digitrans-web-fix.preview.emergentagent.com/api/integrations/xero/callback"
```
