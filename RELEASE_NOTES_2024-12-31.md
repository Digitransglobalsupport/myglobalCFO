...
- Verified single, correct redirect URI: `https://featurectl.preview.emergentagent.com/api/integrations/xero/callback`
...
```
XERO_REDIRECT_URI="https://featurectl.preview.emergentagent.com/api/integrations/xero/callback"
```
