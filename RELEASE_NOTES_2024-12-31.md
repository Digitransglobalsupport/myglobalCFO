...
- Verified single, correct redirect URI: `https://server-config-9.preview.emergentagent.com/api/integrations/xero/callback`
...
```
XERO_REDIRECT_URI="https://server-config-9.preview.emergentagent.com/api/integrations/xero/callback"
```
