...
- Verified single, correct redirect URI: `https://corpfinance-3.preview.emergentagent.com/api/integrations/xero/callback`
...
```
XERO_REDIRECT_URI="https://corpfinance-3.preview.emergentagent.com/api/integrations/xero/callback"
```
