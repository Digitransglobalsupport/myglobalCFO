...
- Verified single, correct redirect URI: `https://core-consolidate.preview.emergentagent.com/api/integrations/xero/callback`
...
```
XERO_REDIRECT_URI="https://core-consolidate.preview.emergentagent.com/api/integrations/xero/callback"
```
