...
- Verified single, correct redirect URI: `https://saas-migration-3.preview.emergentagent.com/api/integrations/xero/callback`
...
```
XERO_REDIRECT_URI="https://saas-migration-3.preview.emergentagent.com/api/integrations/xero/callback"
```
