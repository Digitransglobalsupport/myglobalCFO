...
3. Add this **exact** redirect URI:
   ```
   https://featurectl.preview.emergentagent.com/api/integrations/xero/callback
   ```
...
**Redirect URI**: `https://featurectl.preview.emergentagent.com/api/integrations/xero/callback`
...
2. **Multiple Redirect URIs**: You can add multiple redirect URIs in Xero if you need to support both:
   - Production: `https://featurectl.preview.emergentagent.com/api/integrations/xero/callback`
