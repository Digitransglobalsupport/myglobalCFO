...
3. Add this **exact** redirect URI:
   ```
   https://enterprise-finance-8.preview.emergentagent.com/api/integrations/xero/callback
   ```
...
**Redirect URI**: `https://enterprise-finance-8.preview.emergentagent.com/api/integrations/xero/callback`
...
2. **Multiple Redirect URIs**: You can add multiple redirect URIs in Xero if you need to support both:
   - Production: `https://enterprise-finance-8.preview.emergentagent.com/api/integrations/xero/callback`
