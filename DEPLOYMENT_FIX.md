...
```
https://saas-migration-3.preview.emergentagent.com/api/api/auth/register
                                            ↑    ↑
                                         from env  from code
```
...
echo "REACT_APP_BACKEND_URL=https://saas-migration-3.preview.emergentagent.com" > .env.production
...
5. **Verify in Browser Console**
   ...
   - Should see: `POST https://saas-migration-3.preview.emergentagent.com/api/auth/register`
