...
```
https://smartbooks-39.preview.emergentagent.com/api/api/auth/register
                                            ↑    ↑
                                         from env  from code
```
...
echo "REACT_APP_BACKEND_URL=https://smartbooks-39.preview.emergentagent.com" > .env.production
...
5. **Verify in Browser Console**
   ...
   - Should see: `POST https://smartbooks-39.preview.emergentagent.com/api/auth/register`
