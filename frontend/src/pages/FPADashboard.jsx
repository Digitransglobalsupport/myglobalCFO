...
const FPADashboard = ({ user, onLogout }) => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center">
        <div className="text-lg text-slate-600">Loading FP&A Dashboard...</div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-slate-900">Financial Planning & Analysis</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="p-6 bg-white hover:shadow-lg transition-shadow cursor-pointer"
                onClick={() => navigate('/fpa-dimensions')}>
          ...
          <Card className="p-6 bg-white hover:shadow-lg transition-shadow cursor-pointer"
                onClick={() => navigate('/fpa-integrations')}>
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="space-y-4">
                {versions.slice(0, 5).map((version) => (
                  <div 
                    ...
                    onClick={() => navigate(`/fpa-planning?version=${version.id}`)}
                  >
                    <div className="flex items-center gap-4">
