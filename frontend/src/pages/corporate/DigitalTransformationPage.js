        ...
        <div className="relative container mx-auto px-6">
          <div className="max-w-4xl">
            ...
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              ...
              <span className="text-gradient-cyan">Mergers & Acquisitions</span>
            </h1>
          ...
          <div className="max-w-6xl mx-auto space-y-20">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="glass-card rounded-2xl p-8 lg:p-12">
                <div className="w-16 h-16 bg-[#00F0FF]/10 rounded-2xl flex items-center justify-center mb-6">
                  <GitMerge className="w-8 h-8 text-[#00F0FF]" />
                </div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <div className="text-3xl font-bold text-[#00F0FF]">40%</div>
                    <div className="text-gray-500 text-sm">Faster Integration</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-[#00F0FF]">95%</div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 glass-card rounded-2xl p-8 lg:p-12">
                <div className="w-16 h-16 bg-[#00F0FF]/10 rounded-2xl flex items-center justify-center mb-6">
                  <Workflow className="w-8 h-8 text-[#00F0FF]" />
                </div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <div className="text-3xl font-bold text-[#00F0FF]">60%</div>
                    <div className="text-gray-500 text-sm">Process Efficiency</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-[#00F0FF]">30%</div>
