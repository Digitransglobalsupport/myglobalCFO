  ...
  const getFilteredAndSortedTransactions = () => {
    ...
    if (filters.date) {
      filtered = filtered.filter(t => {
        // Extract just the date part (YYYY-MM-DD) from the transaction date
        const transactionDate = t.date.split('T')[0]; // Handle ISO format
    ...
    <div className="dashboard">
      ...
      <Tabs defaultValue="transactions" className="dashboard-tabs">
        <TabsList data-testid="dashboard-tabs">
          ...
          <TabsTrigger value="fpa" data-testid="fpa-tab">📊 FP&A</TabsTrigger>
        ...
        <TabsContent value="fpa" data-testid="fpa-content">
          <div style={{ height: 'calc(100vh - 150px)', overflow: 'hidden' }}>
            <iframe 
              src="/fpa-dashboard" 
              style={{ 
